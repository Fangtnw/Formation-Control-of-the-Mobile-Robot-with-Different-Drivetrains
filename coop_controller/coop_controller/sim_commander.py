...
def main():
    ...
    initial_pose.pose.position.x = 1.5 #1.5
    initial_pose.pose.position.y = -1.5  #-1.5
    ...
    goal_pose1.pose.position.x = 4.2
    goal_pose1.pose.position.y = -1.2
    goal_pose1.pose.orientation.w = 0.3
    ...
    while not navigator.isTaskComplete():
        ...
        if feedback and i % 5 == 0:
            ...
            if Duration.from_msg(feedback.navigation_time) > Duration(seconds=7735.0):
                goal_pose4 = PoseStamped()
                goal_pose4.header.frame_id = 'map'
                goal_pose4.header.stamp = navigator.get_clock().now().to_msg()
                goal_pose4.pose.position.x = -5.0
