...
xicro_interfaces__action__Toggle_Goal__create()
{
  ...
  xicro_interfaces__action__Toggle_Goal * msg = (xicro_interfaces__action__Toggle_Goal *)allocator.allocate(sizeof(xicro_interfaces__action__Toggle_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
...
xicro_interfaces__action__Toggle_Goal__Sequence__init(xicro_interfaces__action__Toggle_Goal__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (xicro_interfaces__action__Toggle_Goal *)allocator.zero_allocate(size, sizeof(xicro_interfaces__action__Toggle_Goal), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xicro_interfaces__action__Toggle_Goal__Sequence * array = (xicro_interfaces__action__Toggle_Goal__Sequence *)allocator.allocate(sizeof(xicro_interfaces__action__Toggle_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  xicro_interfaces__action__Toggle_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    xicro_interfaces__action__Toggle_Goal * data =
      (xicro_interfaces__action__Toggle_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xicro_interfaces__action__Toggle_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          xicro_interfaces__action__Toggle_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xicro_interfaces__action__Toggle_Result * msg = (xicro_interfaces__action__Toggle_Result *)allocator.allocate(sizeof(xicro_interfaces__action__Toggle_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
...
xicro_interfaces__action__Toggle_Result__Sequence__init(xicro_interfaces__action__Toggle_Result__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (xicro_interfaces__action__Toggle_Result *)allocator.zero_allocate(size, sizeof(xicro_interfaces__action__Toggle_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xicro_interfaces__action__Toggle_Result__Sequence * array = (xicro_interfaces__action__Toggle_Result__Sequence *)allocator.allocate(sizeof(xicro_interfaces__action__Toggle_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  xicro_interfaces__action__Toggle_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    xicro_interfaces__action__Toggle_Result * data =
      (xicro_interfaces__action__Toggle_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xicro_interfaces__action__Toggle_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          xicro_interfaces__action__Toggle_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xicro_interfaces__action__Toggle_Feedback * msg = (xicro_interfaces__action__Toggle_Feedback *)allocator.allocate(sizeof(xicro_interfaces__action__Toggle_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
...
xicro_interfaces__action__Toggle_Feedback__Sequence__init(xicro_interfaces__action__Toggle_Feedback__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (xicro_interfaces__action__Toggle_Feedback *)allocator.zero_allocate(size, sizeof(xicro_interfaces__action__Toggle_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xicro_interfaces__action__Toggle_Feedback__Sequence * array = (xicro_interfaces__action__Toggle_Feedback__Sequence *)allocator.allocate(sizeof(xicro_interfaces__action__Toggle_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  xicro_interfaces__action__Toggle_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    xicro_interfaces__action__Toggle_Feedback * data =
      (xicro_interfaces__action__Toggle_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xicro_interfaces__action__Toggle_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          xicro_interfaces__action__Toggle_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xicro_interfaces__action__Toggle_SendGoal_Request * msg = (xicro_interfaces__action__Toggle_SendGoal_Request *)allocator.allocate(sizeof(xicro_interfaces__action__Toggle_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
xicro_interfaces__action__Toggle_SendGoal_Request__Sequence__init(xicro_interfaces__action__Toggle_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (xicro_interfaces__action__Toggle_SendGoal_Request *)allocator.zero_allocate(size, sizeof(xicro_interfaces__action__Toggle_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xicro_interfaces__action__Toggle_SendGoal_Request__Sequence * array = (xicro_interfaces__action__Toggle_SendGoal_Request__Sequence *)allocator.allocate(sizeof(xicro_interfaces__action__Toggle_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  xicro_interfaces__action__Toggle_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    xicro_interfaces__action__Toggle_SendGoal_Request * data =
      (xicro_interfaces__action__Toggle_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xicro_interfaces__action__Toggle_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          xicro_interfaces__action__Toggle_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xicro_interfaces__action__Toggle_SendGoal_Response * msg = (xicro_interfaces__action__Toggle_SendGoal_Response *)allocator.allocate(sizeof(xicro_interfaces__action__Toggle_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
xicro_interfaces__action__Toggle_SendGoal_Response__Sequence__init(xicro_interfaces__action__Toggle_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (xicro_interfaces__action__Toggle_SendGoal_Response *)allocator.zero_allocate(size, sizeof(xicro_interfaces__action__Toggle_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xicro_interfaces__action__Toggle_SendGoal_Response__Sequence * array = (xicro_interfaces__action__Toggle_SendGoal_Response__Sequence *)allocator.allocate(sizeof(xicro_interfaces__action__Toggle_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  xicro_interfaces__action__Toggle_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    xicro_interfaces__action__Toggle_SendGoal_Response * data =
      (xicro_interfaces__action__Toggle_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xicro_interfaces__action__Toggle_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          xicro_interfaces__action__Toggle_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xicro_interfaces__action__Toggle_GetResult_Request * msg = (xicro_interfaces__action__Toggle_GetResult_Request *)allocator.allocate(sizeof(xicro_interfaces__action__Toggle_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
xicro_interfaces__action__Toggle_GetResult_Request__Sequence__init(xicro_interfaces__action__Toggle_GetResult_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (xicro_interfaces__action__Toggle_GetResult_Request *)allocator.zero_allocate(size, sizeof(xicro_interfaces__action__Toggle_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xicro_interfaces__action__Toggle_GetResult_Request__Sequence * array = (xicro_interfaces__action__Toggle_GetResult_Request__Sequence *)allocator.allocate(sizeof(xicro_interfaces__action__Toggle_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  xicro_interfaces__action__Toggle_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    xicro_interfaces__action__Toggle_GetResult_Request * data =
      (xicro_interfaces__action__Toggle_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xicro_interfaces__action__Toggle_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          xicro_interfaces__action__Toggle_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xicro_interfaces__action__Toggle_GetResult_Response * msg = (xicro_interfaces__action__Toggle_GetResult_Response *)allocator.allocate(sizeof(xicro_interfaces__action__Toggle_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
xicro_interfaces__action__Toggle_GetResult_Response__Sequence__init(xicro_interfaces__action__Toggle_GetResult_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (xicro_interfaces__action__Toggle_GetResult_Response *)allocator.zero_allocate(size, sizeof(xicro_interfaces__action__Toggle_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xicro_interfaces__action__Toggle_GetResult_Response__Sequence * array = (xicro_interfaces__action__Toggle_GetResult_Response__Sequence *)allocator.allocate(sizeof(xicro_interfaces__action__Toggle_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  xicro_interfaces__action__Toggle_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    xicro_interfaces__action__Toggle_GetResult_Response * data =
      (xicro_interfaces__action__Toggle_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xicro_interfaces__action__Toggle_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          xicro_interfaces__action__Toggle_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xicro_interfaces__action__Toggle_FeedbackMessage * msg = (xicro_interfaces__action__Toggle_FeedbackMessage *)allocator.allocate(sizeof(xicro_interfaces__action__Toggle_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
...
xicro_interfaces__action__Toggle_FeedbackMessage__Sequence__init(xicro_interfaces__action__Toggle_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (xicro_interfaces__action__Toggle_FeedbackMessage *)allocator.zero_allocate(size, sizeof(xicro_interfaces__action__Toggle_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xicro_interfaces__action__Toggle_FeedbackMessage__Sequence * array = (xicro_interfaces__action__Toggle_FeedbackMessage__Sequence *)allocator.allocate(sizeof(xicro_interfaces__action__Toggle_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  xicro_interfaces__action__Toggle_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    xicro_interfaces__action__Toggle_FeedbackMessage * data =
      (xicro_interfaces__action__Toggle_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xicro_interfaces__action__Toggle_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          xicro_interfaces__action__Toggle_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
