  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xicro_interfaces__action__Toggle_Goal;
    is_plain =
      (
      offsetof(DataType, a) +
      last_member_size
...
static size_t _Toggle_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xicro_interfaces__action__Toggle_Goal(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xicro_interfaces__action__Toggle_Result;
    is_plain =
      (
...
static size_t _Toggle_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xicro_interfaces__action__Toggle_Result(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xicro_interfaces__action__Toggle_Feedback;
    is_plain =
      (
...
static size_t _Toggle_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xicro_interfaces__action__Toggle_Feedback(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xicro_interfaces__action__Toggle_SendGoal_Request;
    is_plain =
      (
...
static size_t _Toggle_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xicro_interfaces__action__Toggle_SendGoal_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xicro_interfaces__action__Toggle_SendGoal_Response;
    is_plain =
      (
...
static size_t _Toggle_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xicro_interfaces__action__Toggle_SendGoal_Response(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xicro_interfaces__action__Toggle_GetResult_Request;
    is_plain =
      (
...
static size_t _Toggle_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xicro_interfaces__action__Toggle_GetResult_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xicro_interfaces__action__Toggle_GetResult_Response;
    is_plain =
      (
...
static size_t _Toggle_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xicro_interfaces__action__Toggle_GetResult_Response(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xicro_interfaces__action__Toggle_FeedbackMessage;
    is_plain =
      (
...
static size_t _Toggle_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xicro_interfaces__action__Toggle_FeedbackMessage(
    full_bounded, is_plain, 0);
