...
void Xicro::begin(__UART_TYPE *SerialObject){
    ...
    // gen_void_begin
    // gen pointer sub    _nonverify[0][0][0]=&_Subscription_cmd_vel.message.linear.x;    _nonverify[0][1][0]=&_Subscription_cmd_vel.message.linear.y;    _nonverify[0][2][0]=&_Subscription_cmd_vel.message.linear.z;    _nonverify[0][3][0]=&_Subscription_cmd_vel.message.angular.x;    _nonverify[0][4][0]=&_Subscription_cmd_vel.message.angular.y;    _nonverify[0][5][0]=&_Subscription_cmd_vel.message.angular.z;    _verify[0][0][0]=&Subscription_cmd_vel.message.linear.x;    _verify[0][1][0]=&Subscription_cmd_vel.message.linear.y;    _verify[0][2][0]=&Subscription_cmd_vel.message.linear.z;    _verify[0][3][0]=&Subscription_cmd_vel.message.angular.x;    _verify[0][4][0]=&Subscription_cmd_vel.message.angular.y;    _verify[0][5][0]=&Subscription_cmd_vel.message.angular.z;    // gen pointer srv client res    // gen pointer srv server req    // gen pointer action client feed    // gen pointer action server req  
