// ***************************************************************************************************************************************************//      |              This script was auto-generated by generate_arduino_lib.py which received parameters from setup_xicro.yaml               |//      |                                         EDITING THIS FILE BY HAND IS NOT RECOMMENDED                                                 |// ***************************************************************************************************************************************************
...
void Xicro::begin(__UART_TYPE *SerialObject){
    ...
    // gen_void_begin
    // gen pointer sub    _nonverify[0][0][0]=&_Subscription_cmd_vel_follower.message.linear.x;    _nonverify[0][1][0]=&_Subscription_cmd_vel_follower.message.linear.y;    _nonverify[0][2][0]=&_Subscription_cmd_vel_follower.message.linear.z;    _nonverify[0][3][0]=&_Subscription_cmd_vel_follower.message.angular.x;    _nonverify[0][4][0]=&_Subscription_cmd_vel_follower.message.angular.y;    _nonverify[0][5][0]=&_Subscription_cmd_vel_follower.message.angular.z;    _verify[0][0][0]=&Subscription_cmd_vel_follower.message.linear.x;    _verify[0][1][0]=&Subscription_cmd_vel_follower.message.linear.y;    _verify[0][2][0]=&Subscription_cmd_vel_follower.message.linear.z;    _verify[0][3][0]=&Subscription_cmd_vel_follower.message.angular.x;    _verify[0][4][0]=&Subscription_cmd_vel_follower.message.angular.y;    _verify[0][5][0]=&Subscription_cmd_vel_follower.message.angular.z;    // gen pointer srv client res    // gen pointer srv server req    // gen pointer action client feed    // gen pointer action server req  
...
// gen publish voidvoid Xicro::publish_mec_encoder_tick(){
    _crc=0;    _Sendstart();
    _SendSignature(3,4);
    _SendIdTopic(1);
    _SendFloat32((float*)&Publisher_mec_encoder_tick.message.linear.x,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_encoder_tick.message.linear.y,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_encoder_tick.message.linear.z,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_encoder_tick.message.angular.x,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_encoder_tick.message.angular.y,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_encoder_tick.message.angular.z,1);
    _Sendstop();
    _Sendcrc();}
void Xicro::publish_mec_speed_req(){
    _crc=0;    _Sendstart();
    _SendSignature(3,4);
    _SendIdTopic(2);
    _SendFloat32((float*)&Publisher_mec_speed_req.message.linear.x,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_speed_req.message.linear.y,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_speed_req.message.linear.z,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_speed_req.message.angular.x,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_speed_req.message.angular.y,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_speed_req.message.angular.z,1);
    _Sendstop();
    _Sendcrc();}
void Xicro::publish_mec_PWM_cmd(){
    _crc=0;    _Sendstart();
    _SendSignature(3,4);
    _SendIdTopic(3);
    _SendFloat32((float*)&Publisher_mec_PWM_cmd.message.linear.x,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_PWM_cmd.message.linear.y,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_PWM_cmd.message.linear.z,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_PWM_cmd.message.angular.x,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_PWM_cmd.message.angular.y,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_PWM_cmd.message.angular.z,1);
    _Sendstop();
    _Sendcrc();}
void Xicro::publish_mec_speed_cmd(){
    _crc=0;    _Sendstart();
    _SendSignature(3,4);
    _SendIdTopic(4);
    _SendFloat32((float*)&Publisher_mec_speed_cmd.message.linear.x,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_speed_cmd.message.linear.y,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_speed_cmd.message.linear.z,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_speed_cmd.message.angular.x,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_speed_cmd.message.angular.y,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_speed_cmd.message.angular.z,1);
    _Sendstop();
    _Sendcrc();}
void Xicro::publish_mec_imu(){
    _crc=0;    _Sendstart();
    _SendSignature(3,4);
    _SendIdTopic(5);
    _SendFloat32((float*)&Publisher_mec_imu.message.linear.x,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_imu.message.linear.y,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_imu.message.linear.z,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_imu.message.angular.x,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_imu.message.angular.y,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_imu.message.angular.z,1);
    _Sendstop();
    _Sendcrc();}
void Xicro::publish_mec_imu_raw(){
    _crc=0;    _Sendstart();
    _SendSignature(3,4);
    _SendIdTopic(6);
    _SendInt32((int32_t*)&Publisher_mec_imu_raw.message.header.stamp.sec,1);
    _Sendcontinue();
    _SendUint32((uint32_t*)&Publisher_mec_imu_raw.message.header.stamp.nanosec,1);
    _Sendcontinue();
    _SendString(&Publisher_mec_imu_raw.message.header.frame_id,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_imu_raw.message.orientation.x,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_imu_raw.message.orientation.y,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_imu_raw.message.orientation.z,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_imu_raw.message.orientation.w,1);
    _Sendcontinue();
    _SendFloat32(Publisher_mec_imu_raw.message.orientation_covariance,9);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_imu_raw.message.angular_velocity.x,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_imu_raw.message.angular_velocity.y,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_imu_raw.message.angular_velocity.z,1);
    _Sendcontinue();
    _SendFloat32(Publisher_mec_imu_raw.message.angular_velocity_covariance,9);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_imu_raw.message.linear_acceleration.x,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_imu_raw.message.linear_acceleration.y,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_imu_raw.message.linear_acceleration.z,1);
    _Sendcontinue();
    _SendFloat32(Publisher_mec_imu_raw.message.linear_acceleration_covariance,9);
    _Sendstop();
    _Sendcrc();}
void Xicro::publish_mec_encoder_vel(){
    _crc=0;    _Sendstart();
    _SendSignature(3,4);
    _SendIdTopic(7);
    _SendFloat32((float*)&Publisher_mec_encoder_vel.message.linear.x,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_encoder_vel.message.linear.y,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_encoder_vel.message.linear.z,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_encoder_vel.message.angular.x,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_encoder_vel.message.angular.y,1);
    _Sendcontinue();
    _SendFloat32((float*)&Publisher_mec_encoder_vel.message.angular.z,1);
    _Sendstop();
    _Sendcrc();}
